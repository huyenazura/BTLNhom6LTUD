...
{
    public partial class TeacherDashboardForm_Overview : Form
    {
        Ketnoi kn = new Ketnoi();
        private string currentViewName = "";
        private bool isFormLoaded = false;

        public TeacherDashboardForm_Overview()
        {
            InitializeComponent();
        }
        public void HocKi()
        ...
        private void TeacherDashboardForm_Overview_Load(object sender, EventArgs e)
        {
